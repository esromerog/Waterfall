...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			{
                i = GameObject.FindGameObjectWithTag("Checkpoints");
                this.gameObject.transform.position = i.transform.position;
            }
		...
		private void Move()
		{
			...
			// move the player
			_controller.Move(inputDirection.normalized * (4f * Time.unscaledDeltaTime) + new Vector3(0.0f, _verticalVelocity, 0.0f) * Time.unscaledDeltaTime);
		}
